...
extern int *BelemClosure(void* p, int i) {
  data *a = (data *)BOX(NULL);
...
//    if (TAG(a->tag) == SEXP_TAG))
//        return (int*)a->contents + i + 1;
